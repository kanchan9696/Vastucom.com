...
if(isset($_POST['submit'])){
    ...
    $accessory = cleartext($_POST['Role'] ?? '');
    $amount    = cleartext($_POST['amount'] ?? '0');
    $qty       = cleartext($_POST['qty'] ?? '1');

    $name      = cleartext($_POST['accessories_name'] ?? '');
    ...
    $coupon    = cleartext($_POST['dis_coupan_name'] ?? '');
